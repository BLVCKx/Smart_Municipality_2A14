...
public:
    agents();
    agents(QString CIN,QString nom,QString prenom,QString date_naissance,QString email,QString tel,QString profil);
     QString get_CIN();
     QString get_nom();
     QString get_prenom();
     QString get_date();
     ...
     void set_profil(QString profil1){profil=profil1;}
     bool ajouter(QString CIN,QString nom,QString prenom,QString date_naissance,QString email,QString tel,QString profil);
   ...
   bool supprimer(Ui::MainWindow *ui);
    ...
    bool modifier(QString CIN,QString nom,QString prenom,QString Date_naissance,QString email,QString tel,QString profil);
