...
void Equipement::afficherequipement(Ui::MainWindow *ui)
{
...
void Equipement::selectionnerequipement(Ui::MainWindow *ui, const QModelIndex &index)
{ QSqlQuery qry;
    QString val;
...
bool Equipement::supprimerequipement(Ui::MainWindow *ui)
{
    QString id;
